    ...
    return (
        <div className='mt-20 bg-gray-100 pb-16'>
            ...
            <div className=' container mx-auto grid grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-5'>
                ...
                <div className='p-5 ml-20  mx-10 sm:mx-5 -mt-14'>
                    <img src={merchant} className='w-full' alt="" />
                </div>

                <div className=' my-40 sm:my-5 '>
                    <h1 className='text-4xl md:text-3xl sm:text-2xl font-bold text-secondary sm:px-5 md:px-5'>মার্চেন্টদের সফলতার গল্প</h1>
                    <p className='text-secondary font-bold mt-10  sm:px-5 md:px-5'>আমাদের ডিস্ট্রিবিউশনে রেডএক্স গুরুত্বপূর্ণ সহযোগী</p>
