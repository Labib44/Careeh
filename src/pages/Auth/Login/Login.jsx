...
const Login = () => {
  ...
  const handleLogin = (data) => {
    ...
    axios
      .post(`${import.meta.env.VITE_SERVER_URI}/auth/login`, loginInfoData)
      .then((data) => {
        loginWithEmailAndPassword(loginInfoData.email, loginInfoData.password)
          .then((result) => {
  ...
  return (
    <div className="pb-10 bg-gradient-to-tr from-orange-100 from-20% via-orange-300 vai-35% to-gray-50 to-60%">
      <div className="container mx-auto pt-20 relative">
        <h1 className="title font-bold text-5xl text-secondary">Nakam</h1>
        <div className="grid grid-cols-3 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 items-center mt-20">
          <div className="flex flex-col gap-5">
            <h2 className="font-bold text-4xl">Sign In to Rechange Direct</h2>
